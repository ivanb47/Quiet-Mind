...
const ExerciseList = () => {
  ...
  const items = [
    ...
    },
    {
      id: 3,
      title: "Yoga",
      description: "Yoga's incorporation of meditation and breathing can help improve a person's mental well-being. “Regular yoga practice creates mental clarity and calmness; increases body awareness; relieves chronic stress patterns; relaxes the mind; centers attention; and sharpens concentration.",
    ...
    },
    {
      id: 4,
      title: "Swimming",
      description: "Swimming can improve mood in both men and women. For people with fibromyalgia, swimming can decrease anxiety, and exercise therapy in warm water can decrease depression and improve mood.",
    ...
    },
    {
      id: 5,
      title: "Boxing",
      description: "Physically, boxing improves cardiovascular fitness, balance, endurance, strength, and hand-eye coordination. Psychologically, it fosters confidence, concentration, resilience, self-awareness, and stress relief.",
    ...
    },
    {
      id: 6,
      title: "Cycling",
      description: "Cycling and walking both release our 'feel-good' hormones known as endorphins. These hormones help to relax your mind and make you feel happier. This boosts your mood and reduces your feelings of anxiety. Research shows that those who regularly cycle have a significantly lower risk of feeling stressed.",
    ...
    },
    {
      id: 7,
      title: "Meditation",
      description: "The mental health benefits of meditation include better focus and concentration, improved self-awareness and self-esteem, lower levels of stress and anxiety, and fostering kindness. Meditation also has benefits for your physical health, as it can improve your tolerance for pain and help fight substance addiction.",
